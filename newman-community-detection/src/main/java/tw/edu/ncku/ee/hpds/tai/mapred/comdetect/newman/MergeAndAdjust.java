...
public class MergeAndAdjust {
	...
	public static class EdgeWeightAdjusterReducer extends
		...
		public void reduce(Text nodePair, Iterable<DoubleWritable> edgeWeights,
			...
			if ((inKeySplit[0] == CURRENT_MERGE_I) && inKeySplit[1] == "0") {
				...
				for (DoubleWritable ew : edgeWeights) {
					resultValue.set(inKeySplit[0] + "\t" + "0\t"
							+ ew.toString());
				...
				for (DoubleWritable ew : edgeWeights)
					newWeightSum += ew.get();
				resultValue.set(inKeySplit[0] + "\t" + inKeySplit[1] + "\t"
	...
	public static void main(String[] args) throws Exception {
		...
		DistributedCache.addCacheFile(new URI(otherArgs[2]),
